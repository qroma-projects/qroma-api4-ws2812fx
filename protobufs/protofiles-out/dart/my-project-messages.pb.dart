...
import 'qroma-line-target-commands.pb.dart' as $1;
...
class MyProjectCommand extends $pb.GeneratedMessage {
  factory MyProjectCommand({
    ...
    $0.Ws2812FxApiTx? qromaWs2812fxApiTx,
    $1.QromaLineTargetCommand? qromaLineTargetCommand,
  }) {
    final $result = create();
    ...
    if (qromaWs2812fxApiTx != null) {
      $result.qromaWs2812fxApiTx = qromaWs2812fxApiTx;
    }
    if (qromaLineTargetCommand != null) {
      $result.qromaLineTargetCommand = qromaLineTargetCommand;
    }
    return $result;
  }
  ...
  static const $core.Map<$core.int, MyProjectCommand_Command> _MyProjectCommand_CommandByTag = {
    ...
    6 : MyProjectCommand_Command.qromaWs2812fxApiTx,
    7 : MyProjectCommand_Command.qromaLineTargetCommand,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MyProjectCommand', createEmptyInstance: create)
    ...
    ..aOM<$0.Ws2812FxApiTx>(6, _omitFieldNames ? '' : 'qromaWs2812fxApiTx', protoName: 'qromaWs2812fxApiTx', subBuilder: $0.Ws2812FxApiTx.create)
    ..aOM<$1.QromaLineTargetCommand>(7, _omitFieldNames ? '' : 'qromaLineTargetCommand', protoName: 'qromaLineTargetCommand', subBuilder: $1.QromaLineTargetCommand.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(6)
  $0.Ws2812FxApiTx get qromaWs2812fxApiTx => $_getN(5);
  @$pb.TagNumber(6)
  set qromaWs2812fxApiTx($0.Ws2812FxApiTx v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasQromaWs2812fxApiTx() => $_has(5);
  @$pb.TagNumber(6)
  void clearQromaWs2812fxApiTx() => clearField(6);
  @$pb.TagNumber(6)
  $0.Ws2812FxApiTx ensureQromaWs2812fxApiTx() => $_ensure(5);

  @$pb.TagNumber(7)
  $1.QromaLineTargetCommand get qromaLineTargetCommand => $_getN(6);
  @$pb.TagNumber(7)
  set qromaLineTargetCommand($1.QromaLineTargetCommand v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasQromaLineTargetCommand() => $_has(6);
  @$pb.TagNumber(7)
  void clearQromaLineTargetCommand() => clearField(7);
  @$pb.TagNumber(7)
  $1.QromaLineTargetCommand ensureQromaLineTargetCommand() => $_ensure(6);
}
...
class MyProjectResponse extends $pb.GeneratedMessage {
  factory MyProjectResponse({
    ...
    $0.Ws2812FxApiRx? qromaWs2812fxApiRx,
    $1.QromaLineTargetCommand? ackQromaLineTargetCommand,
  }) {
    final $result = create();
    ...
    if (qromaWs2812fxApiRx != null) {
      $result.qromaWs2812fxApiRx = qromaWs2812fxApiRx;
    }
    if (ackQromaLineTargetCommand != null) {
      $result.ackQromaLineTargetCommand = ackQromaLineTargetCommand;
    }
    return $result;
  }
  ...
  static const $core.Map<$core.int, MyProjectResponse_Response> _MyProjectResponse_ResponseByTag = {
    ...
    7 : MyProjectResponse_Response.qromaWs2812fxApiRx,
    8 : MyProjectResponse_Response.ackQromaLineTargetCommand,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MyProjectResponse', createEmptyInstance: create)
    ...
    ..aOM<$0.Ws2812FxApiRx>(7, _omitFieldNames ? '' : 'qromaWs2812fxApiRx', protoName: 'qromaWs2812fxApiRx', subBuilder: $0.Ws2812FxApiRx.create)
    ..aOM<$1.QromaLineTargetCommand>(8, _omitFieldNames ? '' : 'ackQromaLineTargetCommand', protoName: 'ackQromaLineTargetCommand', subBuilder: $1.QromaLineTargetCommand.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(7)
  $0.Ws2812FxApiRx get qromaWs2812fxApiRx => $_getN(6);
  @$pb.TagNumber(7)
  set qromaWs2812fxApiRx($0.Ws2812FxApiRx v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasQromaWs2812fxApiRx() => $_has(6);
  @$pb.TagNumber(7)
  void clearQromaWs2812fxApiRx() => clearField(7);
  @$pb.TagNumber(7)
  $0.Ws2812FxApiRx ensureQromaWs2812fxApiRx() => $_ensure(6);

  @$pb.TagNumber(8)
  $1.QromaLineTargetCommand get ackQromaLineTargetCommand => $_getN(7);
  @$pb.TagNumber(8)
  set ackQromaLineTargetCommand($1.QromaLineTargetCommand v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasAckQromaLineTargetCommand() => $_has(7);
  @$pb.TagNumber(8)
  void clearAckQromaLineTargetCommand() => clearField(8);
  @$pb.TagNumber(8)
  $1.QromaLineTargetCommand ensureAckQromaLineTargetCommand() => $_ensure(7);
}
