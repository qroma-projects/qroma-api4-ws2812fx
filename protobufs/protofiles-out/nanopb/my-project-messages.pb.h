...
#include "qroma-line-target-commands.pb.h"
...
typedef struct _MyProjectCommand { 
    ...
    union {
        ...
        Ws2812FxApiTx qromaWs2812fxApiTx;
...
typedef struct _MyProjectResponse { 
    ...
    union {
        ...
        Ws2812FxApiRx qromaWs2812fxApiRx;
        QromaLineTargetCommand ackQromaLineTargetCommand;
    } response; 
} MyProjectResponse;
...
#define MyProjectCommand_qromaWs2812fxApiTx_tag  6
#define MyProjectCommand_qromaLineTargetCommand_tag 7
...
#define MyProjectResponse_qromaWs2812fxApiRx_tag 7
#define MyProjectResponse_ackQromaLineTargetCommand_tag 8
...
X(a, STATIC,   ONEOF,    MESSAGE,  (command,qromaWs2812fxApiTx,command.qromaWs2812fxApiTx),   6) \
X(a, STATIC,   ONEOF,    MESSAGE,  (command,qromaLineTargetCommand,command.qromaLineTargetCommand),   7)
...
#define MyProjectCommand_command_qromaWs2812fxApiTx_MSGTYPE Ws2812FxApiTx
#define MyProjectCommand_command_qromaLineTargetCommand_MSGTYPE QromaLineTargetCommand
...
X(a, STATIC,   ONEOF,    MESSAGE,  (response,qromaWs2812fxApiRx,response.qromaWs2812fxApiRx),   7) \
X(a, STATIC,   ONEOF,    MESSAGE,  (response,ackQromaLineTargetCommand,response.ackQromaLineTargetCommand),   8)
...
#define MyProjectResponse_response_qromaWs2812fxApiRx_MSGTYPE Ws2812FxApiRx
#define MyProjectResponse_response_ackQromaLineTargetCommand_MSGTYPE QromaLineTargetCommand
...
#define MyProjectCommand_size                    56
