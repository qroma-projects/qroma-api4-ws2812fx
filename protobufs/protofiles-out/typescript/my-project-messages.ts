...
import { Ws2812FxApiRx } from "./qroma-api4-ws2812fx";
import { QromaLineTargetCommand } from "./qroma-line-target-commands";
import { Ws2812FxApiTx } from "./qroma-api4-ws2812fx";
/**
...
export interface MyProjectCommand {
    ...
    command: {
        ...
        oneofKind: "qromaWs2812fxApiTx";
        /**
         * @generated from protobuf field: Ws2812FxApiTx qromaWs2812fxApiTx = 6 [json_name = "qromaWs2812fxApiTx"];
         */
        qromaWs2812fxApiTx: Ws2812FxApiTx;
    } | {
        oneofKind: "qromaLineTargetCommand";
        /**
         * @generated from protobuf field: QromaLineTargetCommand qromaLineTargetCommand = 7;
         */
        qromaLineTargetCommand: QromaLineTargetCommand;
    } | {
        oneofKind: undefined;
    };
}
...
export interface MyProjectResponse {
    ...
    response: {
        ...
        oneofKind: "qromaWs2812fxApiRx";
        /**
         * @generated from protobuf field: Ws2812FxApiRx qromaWs2812fxApiRx = 7 [json_name = "qromaWs2812fxApiRx"];
         */
        qromaWs2812fxApiRx: Ws2812FxApiRx;
    } | {
        oneofKind: "ackQromaLineTargetCommand";
        /**
         * @generated from protobuf field: QromaLineTargetCommand ackQromaLineTargetCommand = 8;
         */
        ackQromaLineTargetCommand: QromaLineTargetCommand;
    } | {
        oneofKind: undefined;
    };
}
...
class MyProjectCommand$Type extends MessageType<MyProjectCommand> {
    constructor() {
        super("MyProjectCommand", [
            ...
            { no: 6, name: "qromaWs2812fxApiTx", kind: "message", localName: "qromaWs2812fxApiTx", jsonName: "qromaWs2812fxApiTx", oneof: "command", T: () => Ws2812FxApiTx },
            { no: 7, name: "qromaLineTargetCommand", kind: "message", oneof: "command", T: () => QromaLineTargetCommand }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* MyProjectConfiguration setMyProjectConfigurationRequest */ 5:
                    ...
                    break;
                case /* Ws2812FxApiTx qromaWs2812fxApiTx = 6 [json_name = "qromaWs2812fxApiTx"];*/ 6:
                    message.command = {
                        oneofKind: "qromaWs2812fxApiTx",
                        qromaWs2812fxApiTx: Ws2812FxApiTx.internalBinaryRead(reader, reader.uint32(), options, (message.command as any).qromaWs2812fxApiTx)
                    };
                    break;
                case /* QromaLineTargetCommand qromaLineTargetCommand */ 7:
                    message.command = {
                        oneofKind: "qromaLineTargetCommand",
                        qromaLineTargetCommand: QromaLineTargetCommand.internalBinaryRead(reader, reader.uint32(), options, (message.command as any).qromaLineTargetCommand)
                    };
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: MyProjectCommand, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* Ws2812FxApiTx qromaWs2812fxApiTx = 6 [json_name = "qromaWs2812fxApiTx"]; */
        if (message.command.oneofKind === "qromaWs2812fxApiTx")
            Ws2812FxApiTx.internalBinaryWrite(message.command.qromaWs2812fxApiTx, writer.tag(6, WireType.LengthDelimited).fork(), options).join();
        /* QromaLineTargetCommand qromaLineTargetCommand = 7; */
        if (message.command.oneofKind === "qromaLineTargetCommand")
            QromaLineTargetCommand.internalBinaryWrite(message.command.qromaLineTargetCommand, writer.tag(7, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class MyProjectResponse$Type extends MessageType<MyProjectResponse> {
    constructor() {
        super("MyProjectResponse", [
            ...
            { no: 7, name: "qromaWs2812fxApiRx", kind: "message", localName: "qromaWs2812fxApiRx", jsonName: "qromaWs2812fxApiRx", oneof: "response", T: () => Ws2812FxApiRx },
            { no: 8, name: "ackQromaLineTargetCommand", kind: "message", oneof: "response", T: () => QromaLineTargetCommand }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* GetProjectDetailsResponse getProjectDetailsResponse */ 6:
                    ...
                    break;
                case /* Ws2812FxApiRx qromaWs2812fxApiRx = 7 [json_name = "qromaWs2812fxApiRx"];*/ 7:
                    message.response = {
                        oneofKind: "qromaWs2812fxApiRx",
                        qromaWs2812fxApiRx: Ws2812FxApiRx.internalBinaryRead(reader, reader.uint32(), options, (message.response as any).qromaWs2812fxApiRx)
                    };
                    break;
                case /* QromaLineTargetCommand ackQromaLineTargetCommand */ 8:
                    message.response = {
                        oneofKind: "ackQromaLineTargetCommand",
                        ackQromaLineTargetCommand: QromaLineTargetCommand.internalBinaryRead(reader, reader.uint32(), options, (message.response as any).ackQromaLineTargetCommand)
                    };
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: MyProjectResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* Ws2812FxApiRx qromaWs2812fxApiRx = 7 [json_name = "qromaWs2812fxApiRx"]; */
        if (message.response.oneofKind === "qromaWs2812fxApiRx")
            Ws2812FxApiRx.internalBinaryWrite(message.response.qromaWs2812fxApiRx, writer.tag(7, WireType.LengthDelimited).fork(), options).join();
        /* QromaLineTargetCommand ackQromaLineTargetCommand = 8; */
        if (message.response.oneofKind === "ackQromaLineTargetCommand")
            QromaLineTargetCommand.internalBinaryWrite(message.response.ackQromaLineTargetCommand, writer.tag(8, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
